...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'Gallery Époque', url: 'https://galleryepoque.org' }],
  creator: 'Gallery Époque',
  publisher: 'Gallery Époque',
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
